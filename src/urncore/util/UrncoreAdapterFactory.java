...
public class UrncoreAdapterFactory extends AdapterFactoryImpl {
	...
	public Adapter createCommentAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link urncore.FeatureModel <em>Feature Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createFeatureModelAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link urncore.Feature <em>Feature</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
